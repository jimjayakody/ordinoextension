...
/** Reuse the Connector tab when it has a real app URL; otherwise open a clean tab for tests. */
async function resolveTestPage(context: BrowserContext): Promise<Page> {
